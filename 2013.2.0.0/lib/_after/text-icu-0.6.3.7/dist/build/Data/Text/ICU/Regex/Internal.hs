...
{-# LINE 2 "Data\Text\ICU\Regex\Internal.hsc" #-}
...
{-# LINE 61 "Data\Text\ICU\Regex\Internal.hsc" #-}
  ...
  where
    go (!flag,work,stack) opt = (flag+flag',work',stack')
     where
      flag' = case opt of
                CaseInsensitive       -> 2
{-# LINE 179 "Data\Text\ICU\Regex\Internal.hsc" #-}
                Comments              -> 4
{-# LINE 180 "Data\Text\ICU\Regex\Internal.hsc" #-}
                DotAll                -> 32
{-# LINE 181 "Data\Text\ICU\Regex\Internal.hsc" #-}
                Literal               -> 16
{-# LINE 182 "Data\Text\ICU\Regex\Internal.hsc" #-}
                Multiline             -> 8
{-# LINE 183 "Data\Text\ICU\Regex\Internal.hsc" #-}
                HaskellLines          -> 1
{-# LINE 184 "Data\Text\ICU\Regex\Internal.hsc" #-}
                UnicodeWord           -> 256
{-# LINE 185 "Data\Text\ICU\Regex\Internal.hsc" #-}
                ErrorOnUnknownEscapes -> 512
{-# LINE 186 "Data\Text\ICU\Regex\Internal.hsc" #-}
                _                     -> 0
      work' = case opt of
