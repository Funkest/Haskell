...
{-# LINE 87 "Data\Text\ICU\Char.hsc" #-}
...
instance Property BidiClass_ Direction where
    ...
    toUProperty _ = (4096)
{-# LINE 434 "Data\Text\ICU\Char.hsc" #-}
...
instance Property Block_ BlockCode where
    fromNative _  = toEnum . fromIntegral
    toUProperty _ = (4097)
{-# LINE 440 "Data\Text\ICU\Char.hsc" #-}
...
instance Property CanonicalCombiningClass_ Int where
    ...
    toUProperty _ = (4098)
{-# LINE 446 "Data\Text\ICU\Char.hsc" #-}
...
instance Property Decomposition_ (Maybe Decomposition) where
    ...
    toUProperty _ = (4099)
{-# LINE 473 "Data\Text\ICU\Char.hsc" #-}
...
instance Property EastAsianWidth_ EastAsianWidth where
    fromNative _  = toEnum . fromIntegral
    toUProperty _ = (4100)
{-# LINE 488 "Data\Text\ICU\Char.hsc" #-}
...
instance Property GeneralCategory_ GeneralCategory where
    fromNative _  = toEnum . fromIntegral
    toUProperty _ = (4101)
{-# LINE 531 "Data\Text\ICU\Char.hsc" #-}
...
instance Property JoiningGroup_ (Maybe JoiningGroup) where
    fromNative _  = maybeEnum
    toUProperty _ = (4102)
{-# LINE 598 "Data\Text\ICU\Char.hsc" #-}
...
instance Property JoiningType_ (Maybe JoiningType) where
    fromNative _  = maybeEnum
    toUProperty _ = (4103)
{-# LINE 612 "Data\Text\ICU\Char.hsc" #-}
...
instance Property NumericType_ (Maybe NumericType) where
    fromNative _  = maybeEnum
    toUProperty _ = (4105)
{-# LINE 665 "Data\Text\ICU\Char.hsc" #-}
...
instance Property HangulSyllableType_ (Maybe HangulSyllableType) where
    fromNative _  = maybeEnum
    toUProperty _ = (4107)
{-# LINE 679 "Data\Text\ICU\Char.hsc" #-}
...
instance Property LeadCanonicalCombiningClass_ Int where
    fromNative  _ = fromIntegral
    toUProperty _ = (4112)
{-# LINE 707 "Data\Text\ICU\Char.hsc" #-}
...
instance Property TrailingCanonicalCombiningClass_ Int where
    fromNative  _ = fromIntegral
    toUProperty _ = (4113)
{-# LINE 714 "Data\Text\ICU\Char.hsc" #-}
...
instance Property GraphemeClusterBreak_ (Maybe GraphemeClusterBreak) where
    fromNative  _ = maybeEnum
    toUProperty _ = (4114)
{-# LINE 734 "Data\Text\ICU\Char.hsc" #-}
...
instance Property SentenceBreak_ (Maybe SentenceBreak) where
    fromNative  _ = maybeEnum
    toUProperty _ = (4115)
{-# LINE 757 "Data\Text\ICU\Char.hsc" #-}
...
instance Property WordBreak_ (Maybe WordBreak) where
    fromNative  _ = maybeEnum
    toUProperty _ = (4116)
{-# LINE 778 "Data\Text\ICU\Char.hsc" #-}
...
numericValue c
    | v == (-123456789) = Nothing
{-# LINE 849 "Data\Text\ICU\Char.hsc" #-}
    | otherwise                        = Just v
...
charName = charName' (0)
{-# LINE 860 "Data\Text\ICU\Char.hsc" #-}
...
{-# LINE 868 "Data\Text\ICU\Char.hsc" #-}
...
{-# LINE 878 "Data\Text\ICU\Char.hsc" #-}
...
{-# LINE 892 "Data\Text\ICU\Char.hsc" #-}
