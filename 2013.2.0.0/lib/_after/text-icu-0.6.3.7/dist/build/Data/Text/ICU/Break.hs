...
{-# LINE 2 "Data\Text\ICU\Break.hsc" #-}
-- |
...
{-# LINE 51 "Data\Text\ICU\Break.hsc" #-}
...
{-# LINE 104 "Data\Text\ICU\Break.hsc" #-}
...
{-# LINE 112 "Data\Text\ICU\Break.hsc" #-}
  where
    asLine i
      | i < (100) = Soft
{-# LINE 115 "Data\Text\ICU\Break.hsc" #-}
      | i < (200) = Hard
{-# LINE 116 "Data\Text\ICU\Break.hsc" #-}
...
{-# LINE 125 "Data\Text\ICU\Break.hsc" #-}
...
{-# LINE 136 "Data\Text\ICU\Break.hsc" #-}
  where
    asWord i
      | i < (100) = Uncategorized
{-# LINE 139 "Data\Text\ICU\Break.hsc" #-}
      | i < (200) = Number
{-# LINE 140 "Data\Text\ICU\Break.hsc" #-}
      | i < (300) = Letter
{-# LINE 141 "Data\Text\ICU\Break.hsc" #-}
      | i < (400) = Kana
...
asIndex act BR{..} = do
  ...
  return $! if i == (-1)
{-# LINE 175 "Data\Text\ICU\Break.hsc" #-}
            then Nothing
