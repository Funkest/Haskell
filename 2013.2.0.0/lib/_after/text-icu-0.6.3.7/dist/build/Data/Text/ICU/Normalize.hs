...
{-# LINE 2 "Data\Text\ICU\Normalize.hsc" #-}
-- |
...
{-# LINE 31 "Data\Text\ICU\Normalize.hsc" #-}

{-# LINE 32 "Data\Text\ICU\Normalize.hsc" #-}

{-# LINE 33 "Data\Text\ICU\Normalize.hsc" #-}


{-# LINE 35 "Data\Text\ICU\Normalize.hsc" #-}
...
fromCompareOption InputIsFCD              = 131072
{-# LINE 177 "Data\Text\ICU\Normalize.hsc" #-}
fromCompareOption CompareIgnoreCase       = 65536
{-# LINE 178 "Data\Text\ICU\Normalize.hsc" #-}
...
reduceCompareOptions = foldl' orO (32768)
{-# LINE 182 "Data\Text\ICU\Normalize.hsc" #-}
...
toNM None = 1
{-# LINE 198 "Data\Text\ICU\Normalize.hsc" #-}
toNM NFD  = 2
{-# LINE 199 "Data\Text\ICU\Normalize.hsc" #-}
toNM NFKD = 3
