...
oFFSET_Capability_context_switch = 192
...
oFFSET_Capability_interrupt = 196
...
sIZEOF_generation = 240
oFFSET_generation_n_new_large_words :: Int
oFFSET_generation_n_new_large_words = 28
...
oFFSET_CostCentreStack_mem_alloc = 40
...
oFFSET_CostCentreStack_scc_count = 24
...
oFFSET_StgTSO_blocked_exceptions = 48
...
sIZEOF_StgAtomicallyFrame_NoHdr = 12
...
oFFSET_StgAtomicallyFrame_result = 8
...
sIZEOF_StgMVarTSOQueue_NoHdr = 8
...
sIZEOF_StgBlockingQueue_NoHdr = 16
oFFSET_StgBlockingQueue_bh :: Int
oFFSET_StgBlockingQueue_bh = 4
...
oFFSET_StgBlockingQueue_owner = 8
...
oFFSET_StgBlockingQueue_queue = 12
...
sIZEOF_MessageBlackHole_NoHdr = 12
...
sIZEOF_StgAsyncIOResult :: Int
sIZEOF_StgAsyncIOResult = 12
oFFSET_StgAsyncIOResult_reqID :: Int
oFFSET_StgAsyncIOResult_reqID = 0
#define StgAsyncIOResult_reqID(__ptr__)  REP_StgAsyncIOResult_reqID[__ptr__+OFFSET_StgAsyncIOResult_reqID]
oFFSET_StgAsyncIOResult_len :: Int
oFFSET_StgAsyncIOResult_len = 4
#define StgAsyncIOResult_len(__ptr__)  REP_StgAsyncIOResult_len[__ptr__+OFFSET_StgAsyncIOResult_len]
oFFSET_StgAsyncIOResult_errCode :: Int
oFFSET_StgAsyncIOResult_errCode = 8
#define StgAsyncIOResult_errCode(__ptr__)  REP_StgAsyncIOResult_errCode[__ptr__+OFFSET_StgAsyncIOResult_errCode]
